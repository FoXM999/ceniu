...
file_path = os.path.join("D:\\迅雷下载", 'chromedriver-win64.zip')
driver.find_element(By.CSS_SELECTOR, "input[type='file']").send_keys(file_path)

WebDriverWait(driver, 60).until(
    ec.presence_of_element_located((By.XPATH, "//span[text()='上传完成']"))
)
driver.find_element(By.CSS_SELECTOR, ".nui-ipt-input[maxlength='256']").send_keys('file upload complete')
